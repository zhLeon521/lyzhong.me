  ...
  return (
    <div className="flex flex-col justify-between">
      <Head>
        ...
        <meta name="description" content={meta.summary ? meta.summary : meta.description[router.locale]} />
        <link
          rel="alternate"
        ...
        <meta property="og:description" content={meta.summary ? meta.summary : meta.description[router.locale]} />
        <meta property="og:title" content={meta.title} />
        {meta.date && <meta property="article:published_time" content={meta.date} />}
        {meta.lastmod && <meta property="article:modified_time" content={meta.lastmod} />}
        <meta property="og:image" content={`${meta.image}`} />
        <meta property="og:image:alt" content={meta.summary ? meta.summary : meta.description[router.locale]} />
        <meta property="og:image:type" content="image/png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:locale" content={router.locale.replace('-', '_').toLowerCase()} />
        <meta name="twitter:image" content={`${meta.image}`} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@TszhongLai0411" />
        <meta name="twitter:title" content={`${meta.title} | honghong.me`} />
        <meta name="twitter:description" content={meta.summary ? meta.summary : meta.description[router.locale]} />
